...
RUN wget --directory-prefix=/usr/local http://download.agisoft.com/photoscan-pro_1_4_2_amd64.tar.gz ;\
(cd /usr/local && tar zxvf photoscan-pro_1_4_2_amd64.tar.gz) ;\
(cd /usr/local/bin && ln -s ../photoscan-pro/photoscan-pro.sh) ;\
rm -f /usr/local/photoscan-pro_1_4_2_amd64.tar.gz ;\
